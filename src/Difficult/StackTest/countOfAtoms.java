...
public class countOfAtoms {
    ...
    public String countOfAtoms(String formula) {
        ...
        for (Map.Entry<String,Integer> entry:map.entrySet()){
            ...
            res.append(entry.getValue()==1?"":entry.getValue());
        }
        return res.toString();
    }
    ...
    public static void main(String[] args) {
        System.out.println(new countOfAtoms().countOfAtoms1("((N42)24(OB40Li30CHe3O48LiNN26)33(C12Li48N30H13HBe31)21(BHN30Li26BCBe47N40)15(H5)16)14"));
    }
}
